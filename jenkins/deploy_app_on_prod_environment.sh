...
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-aredo/stable/myapp/ || echo "repository name already exists"
...
AWS_REGION=$AWS_REGION helm upgrade --install \
    petclinic-app-release stable-petclinic/petclinic_chart --set DNS_NAME='petclinic.aredodevops.com' --version ${BUILD_NUMBER} \
